...
public class ProjectileMotionSolver {
    ...
    /**
     * @param launchAngle The angle from the horizontal, in degrees, that the projectile begins
     *     motion in. For reference, 90 is completely vertical and 0 is completely horizontal.
     */
    ...
    /**
     * @param simulationStep Number of seconds between each "tick" in the simulation, 0.01 by
     *     default.
     */
     ...
     *     optimal launch velocity, 10 by default. Each iteration doubles the precision using a
     *     binary search.
     */
     ...
     *
     * @param goalDisplacement A Vector2 representing the goal's relative position from the
     *     launching position of the projectile, where x is the horizontal distance of the goal and
     *     y is the height of the goal.
     ...
     * @return A Vector2 where x is the launch velocity and y is the turret offset angle. NOTE: may
     *     be null
     */
