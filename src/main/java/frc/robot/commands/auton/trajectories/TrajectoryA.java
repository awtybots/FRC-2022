  ...
  static {
    TrajectoryConfig trajectoryConfig =
        new TrajectoryConfig(
            DrivetrainSubsystem.kTrajectoryMaxVelocity,
            DrivetrainSubsystem.kTrajectoryMaxAcceleration);
    ...
    trajectoryConfig.addConstraint(
        new DifferentialDriveVoltageConstraint(
            ...
            DrivetrainSubsystem.kMaxTrajectoryVoltage));

    trajectory =
        null; // TrajectoryGenerator.generateTrajectory(initial, interiorWaypoints, end, config)
  }
