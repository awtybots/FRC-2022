...
public class TurretSubsystem extends SubsystemBase {
    ...
    private static final double kAngleMin = -60.0;
    ...
    private static final double kNominalOutput = 0.00;
    private static final double kClosedLoopPeakOutput = 0.4;
    private static final double kMaxAngularSpeed = 110.0;
    ...
    private void configMotors() {
        ...
        mMotor.configNeutralDeadband(kNominalOutput);
        mMotor.configNominalOutputForward(kNominalOutput);
        mMotor.configNominalOutputReverse(-kNominalOutput);
        ...
        mMotor.setSelectedSensorPosition(
                Convert.angleToEncoderPos(
                        kAngleStart, kGearRatio, Encoder.VersaPlanetaryIntegrated));
    }
    ...
    public void periodic() {
        ...
        if (Constants.TUNING_MODE) {
            ...
            //         mMotor.getSelectedSensorVelocity(), kGearRatio,
            // Encoder.VersaPlanetaryIntegrated));
        }
    }
    ...
    private void turnToPrivate(double absoluteAngle) {
        ...
        mMotor.set(
                ...
                Convert.angleToEncoderPos(
                        mTargetAngle, kGearRatio, Encoder.VersaPlanetaryIntegrated));
    }
    ...
    public void spit(boolean hasTarget, double targetOffsetAngle) {
        ...
        if (hasTarget) {
            ...
            double boundedAngle =
                    clampToBounds(mCurrentAngle + targetOffsetAngle + kSpitRelativeAngle);
